import { fetchYearlyReport } from "./requests.js";

let yearlyReport;

document.addEventListener('DOMContentLoaded', async ()=>{
    yearlyReport = await fetchYearlyReport();
    createOverallGraph(yearlyReport);
});
...
document.getElementById("reportArea").addEventListener("change" , ()=>{
    ...
    if(reportEl.value == "overall"){
        ...
        createDeviceGraphs(yearlyReport);
    }
    else if(reportEl.value == "counties"){
        createCountyGraphs(yearlyReport);
    }
    else if(reportEl.value == "regions"){
        createRegionGraphs(yearlyReport);
    }
});
