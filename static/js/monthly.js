import { fetchMonthlyReport } from "./requests.js";

let monthlyReport;

document.addEventListener('DOMContentLoaded', async ()=>{
    monthlyReport = await fetchMonthlyReport();
    createOverallGraph(monthlyReport);
});
...
document.getElementById("reportArea").addEventListener("change" , ()=>{
    ...
    if(reportEl.value == "overall"){
        ...
        createDeviceGraphs(monthlyReport);
    }
    else if(reportEl.value == "counties"){
        createCountyGraphs(monthlyReport);
    }
    else if(reportEl.value == "regions"){
        createRegionGraphs(monthlyReport);
    }
});
